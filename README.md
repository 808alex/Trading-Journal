...
2. **Windows:** double-click `start.bat`. It installs dependencies on first run and opens the app in your browser automatically.
...
Want it one click away? Make a shortcut to `start.bat` (Windows: right-click it → **Send to → Desktop (create shortcut)**) and pin that to your desktop or taskbar.
